# 🚨 WizeTax-FlowsV6 action items — 2026-05-31

**3 failure(s), 8 warning(s), 31 pass.**
...
- ✅ Failover: /api/chat timeout/abort → no uncaught page error
...
- ✅ Rate-limit UX: 429 does not throw an uncaught error
...
- ✅ Back/forward: forward navigation re-reaches advisor without error
- ⚠️ chip tap height 27px < 40px target — small tap target on Pixel 7
...
- ✅ i18n: EN → html dir flips to ltr
- ✅ i18n: PT → ltr + no Hebrew leak on visible buttons
- ✅ i18n: ES → ltr + Spanish copy detected
